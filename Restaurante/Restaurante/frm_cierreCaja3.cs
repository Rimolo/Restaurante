...
{
    public partial class frm_cierreCaja3 : Form
    {
        ...
        public frm_cierreCaja3()
        {
            InitializeComponent();
        }

        private void frm_cierreCaja3_Load(object sender, EventArgs e)
        {
            mostrarConsecutivo();
        }
        ...
        private void b_aceptar_Click(object sender, EventArgs e)
        {
            ...
            objCajas.codRest = objCajas.obtener_cod_rest("Notte Di Fuoco");
