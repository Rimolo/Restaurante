...
{
    public partial class frm_NotteDiFouco : Form
    {
        ...
        {
            frm_cierreCaja3 caja = new frm_cierreCaja3();
            caja.nick = _nick;
        ...
        private void b_mesa1_Click(object sender, EventArgs e)
        {
            ...
            clientes.nombreR = "Notte Di Fuoco";
            clientes.codR = _codRest;
        ...
        private void frm_NotteDiFouco_Load(object sender, EventArgs e)
        {
            timer1.Start();
        ...
        private void b_mesa25_Click(object sender, EventArgs e)
        {
        ...
        private void b_mesa24_Click(object sender, EventArgs e)
        {

        }

        private void b_mesa27_Click(object sender, EventArgs e)
        {

        }

        private void b_mesa28_Click(object sender, EventArgs e)
        {
