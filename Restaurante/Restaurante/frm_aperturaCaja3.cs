...
{
    public partial class frm_aperturaCaja3 : Form
    {
        ...
        public frm_aperturaCaja3()
        {
            InitializeComponent();
        }

        private void frm_aperturaCaja3_Load(object sender, EventArgs e)
        {
            try
            {
                DataSet ds1;
        ...
        private void b_aceptar_Click(object sender, EventArgs e)
        {
            ...
            if (objCajas.guardar_caja("Insertar"))
            {
                ...
                try
                {
                    ...
                    {
                        frm_NotteDiFouco notte = new frm_NotteDiFouco();
                        notte.nick = this._nick;
                        notte.codRest = objCajas.codRest;
                        notte.Show();
                        this.Close();
                    }
