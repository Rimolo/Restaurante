...
{
    public partial class frm_aperturaCaja2 : Form
    {
        ...
        private void b_aceptar_Click(object sender, EventArgs e)
        {
            ...
            if (objCajas.guardar_caja("Insertar"))
            {
                ...
                try
                {
                    ...
                    {
                        frm_TurinAnivo turin = new frm_TurinAnivo();
                        turin.nick = this._nick;
                        turin.codRest = objCajas.codRest;
                        turin.Show();
                        this.Close();
                    }
        ...
        private void frm_aperturaCaja2_Load(object sender, EventArgs e)
        {
            mostrarConsecutivo();
        }
